package es.devcircus.services.inventory.api.shipment.dto;
...
public class ShipmentDto {
    ...
    public ShipmentDto(Set<Inventory> inventories, Address deliveryAddress, Warehouse fromWarehouse, ShipmentStatus shipmentStatus) {
