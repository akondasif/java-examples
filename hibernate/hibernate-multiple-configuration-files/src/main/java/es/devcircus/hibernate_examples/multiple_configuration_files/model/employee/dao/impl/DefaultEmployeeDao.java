 ...
 */
package es.devcircus.hibernate_examples.multiple_configuration_files.model.employee.dao.impl;

import es.devcircus.hibernate_examples.multiple_configuration_files.model.employee.dao.IEmployeeDao;
import es.devcircus.hibernate_examples.multiple_configuration_files.model.employee.vo.Employee;
import es.devcircus.hibernate_examples.multiple_configuration_files.util.EmployeeHibernateUtil;
...
public class DefaultEmployeeDao implements IEmployeeDao {
    ...
    public List<Employee> list()
            throws DaoException {
        SessionFactory sf = EmployeeHibernateUtil.getSessionFactory();
