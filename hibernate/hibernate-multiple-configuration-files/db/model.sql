...
--
-- Base de datos: `multiple_configuration_files`
--
CREATE DATABASE IF NOT EXISTS hibernate_multiple_configuration_files DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `hibernate_multiple_configuration_files`;
