...
--
-- Base de datos: `hibernate_inheritance_one_table_per_subclass`
--
CREATE DATABASE IF NOT EXISTS hibernate_inheritance_one_table_per_subclass DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `hibernate_inheritance_one_table_per_subclass`;
