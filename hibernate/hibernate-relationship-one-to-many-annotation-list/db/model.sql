...
--
-- Base de datos: `hibernate_relationship_one_to_many_annotation_list`
--
CREATE DATABASE IF NOT EXISTS hibernate_relationship_one_to_many_annotation_list DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `hibernate_relationship_one_to_many_annotation_list`;
