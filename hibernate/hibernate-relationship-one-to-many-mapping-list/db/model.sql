...
--
-- Base de datos: `hibernate_relationship_one_to_many_mapping_list`
--
CREATE DATABASE IF NOT EXISTS hibernate_relationship_one_to_many_mapping_list DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `hibernate_relationship_one_to_many_mapping_list`;
