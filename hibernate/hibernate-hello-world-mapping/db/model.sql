...
--
-- Base de datos: `hibernate_hello_world_mapping`
--
CREATE DATABASE IF NOT EXISTS hibernate_hello_world_mapping DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `hibernate_hello_world_mapping`;
