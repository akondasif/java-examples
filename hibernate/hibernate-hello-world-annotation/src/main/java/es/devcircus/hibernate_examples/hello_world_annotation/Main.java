 ...
 */
package es.devcircus.hibernate_examples.hello_world_annotation;

import es.devcircus.hibernate_examples.hello_world_annotation.model.Employee;
import es.devcircus.hibernate_examples.hello_world_annotation.util.HibernateUtil;
