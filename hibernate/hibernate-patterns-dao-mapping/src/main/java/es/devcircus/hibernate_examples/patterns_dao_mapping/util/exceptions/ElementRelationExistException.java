 ...
 * @description
 */
public class ElementRelationExistException extends ModelException {

    /**
     *
     */
    public ElementRelationExistException() {
        super();
    }
     ...
     * @param s
     */
    public ElementRelationExistException(String s) {
        super(s);
    }
     ...
     * @param exception
     */
    public ElementRelationExistException(Throwable exception) {
        super(exception);
    }
}
