...
--
-- Base de datos: `hibernate_relationship_one_to_one_mapping`
--
CREATE DATABASE IF NOT EXISTS hibernate_relationship_one_to_one_mapping DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `hibernate_relationship_one_to_one_mapping`;
