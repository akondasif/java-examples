...
--
-- Base de datos: `hibernate_relationship_many_to_many_annotation`
--
CREATE DATABASE IF NOT EXISTS hibernate_relationship_many_to_many_annotation DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `hibernate_relationship_many_to_many_annotation`;
