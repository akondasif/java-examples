 ...
 * @description
 */
public class ElementNonExistException extends ModelException {

    /**
     *
     */
    public ElementNonExistException() {
        super();
    }
     ...
     * @param s
     */
    public ElementNonExistException(String s) {
        super(s);
    }
     ...
     * @param exception
     */
    public ElementNonExistException(Throwable exception) {
        super(exception);
    }
}
