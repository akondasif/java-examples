...
--
-- Base de datos: `hibernate_patterns_facade_dao_mapping`
--
CREATE DATABASE IF NOT EXISTS hibernate_patterns_facade_dao_mapping DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `hibernate_patterns_facade_dao_mapping`;
